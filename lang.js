...
It's difficult to use.`
    ...
    rand_name: {
        pl: `Losowe nazwy:
Ten program losowo wybiera nazwy z listy.`,
        en: `Random Names:
This program randomly selects names from a list.`
    },
    name: { pl: "Imię: Krystian T. Kaminski", en: "NAME: Krystian T. Kaminski" },
    birthdate: { pl: "Data urodzenia:\n06/12/09", en: "Birthdate:\n06/12/09" },
    school: { pl: "Obecna Szkoła:\nLBS Halmstad", en: "Current School:\nLBS Halmstad" },
...
interest`
    ...
    py_3: {
        pl: "Uczę się obsługi biblioteki pybind11 w celu połączenia PY z C++.",
        en: "I am learning the pybind11 library to connect PY to C++."
    },
    about_me_2: {
        pl: `Moim głównym językiem jest C++, ale znam zarówno Pythona, jak i języki programowania stron internetowych.`,
        en: `My primary language is C++, but I know both Python and web development languages.`
    },
    about_me_3: {
        pl: `Szybko uczę się nowych języków i technologii, ale nie lubię pracować z językami takimi jak C#.`,
        en: `I'm quick to learn new languages ​​and technologies, but I don't like working with languages ​​like C#.`
    },
    about_me_4: {
        pl: `Moja kariera jest młoda, ale rozwija się dynamicznie. Podejrzewam, że osiągnę poziom średni tego lata.`,
        en: `My career is young, but it's developing rapidly. I suspect I'll reach mid-level this summer.`
    },
    about_me: { pl: "O mnie:", en: "About me:" },
...
This was my first standalone C++ project.`
    ...
    your_name: { pl: "Twoje imię:", en: "Your name:" },
    your_email: { pl: "Twój email:", en: "Your email:" },
    your_message: { pl: "Twoja wiadomość:", en: "Your message:" }
};
